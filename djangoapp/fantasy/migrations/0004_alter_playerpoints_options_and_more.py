...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('Keeper', 'Keeper'), ('Defender', 'Defender'), ('Midfield', 'Midfield'), ('Forward', 'Forward')], default='Midfield', max_length=64),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('Keeper', 'Keeper'), ('Defender', 'Defender'), ('Midfield', 'Midfield'), ('Forward', 'Forward')], max_length=256)),
